...
module.exports = {
  ...
  if (args.length === 0) {
      ...
      msg += `𝗧𝘆𝗽𝗲 ${prefix}𝗵𝗲𝗹𝗽 [TOUHID-BOT] 𝘁𝗼 𝘃𝗶𝗲𝘄 𝘁𝗵𝗲 𝗱𝗲𝘁𝗮𝗶𝗹𝘀 𝗼𝗳 𝘁𝗵𝗮𝘁 𝗰𝗼𝗺𝗺𝗮𝗻𝗱\n`;
      msg += `🌟 | 𝐓𝐎𝐔𝐇𝐈𝐃-𝐁𝐎𝐓 `;


      const helpListImages = [
        "https://i.imgur.com/Mgf0VPH.mp4-17.jpg", // add image link here
